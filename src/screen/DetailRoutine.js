...
const images = [
    { id: '1', uri: 'https://images.unsplash.com/flagged/photo-1556746834-cbb4a38ee593?q=80&w=3272&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { id: '2', uri: 'https://images.unsplash.com/photo-1518365658347-c4906efc5636?q=80&w=3122&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { id: '3', uri: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
];
const DetailRoutine = () => {
    const [currentIndex, setCurrentIndex] = useState(0);

    const renderItem = ({ item }) => (
        <Image source={{ uri: item.uri }} style={{ width: 363, height: 500 }} resizeMode="cover" />
    );
